...
![Example graph of reservoir variables for SPE11C. Arrows indicate direction of dependency. Each of these entries represent an array that must be resdient on the GPU.](graph_spe11c.png)
